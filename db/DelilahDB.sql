...
INSERT INTO usuarios (username, fullname, email, phone, address, pass, esAdmin) 
				VALUES ('rodri', 'Rodrigo', 'rodri@gmail.com', '153846978', 'borne 1568', 'miproyecto3',true);
...
-- -----------------------------------------------------
-- Table `proyecto3`.`platos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyecto3`.`platos` (
